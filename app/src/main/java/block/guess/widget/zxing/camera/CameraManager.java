package block.guess.widget.zxing.camera;
...
public final class CameraManager {
     ...
     */
    public boolean openDriver(SurfaceHolder holder, int width, int height) throws IOException {
        if (mCamera == null) {
            try {
                mCamera = Camera.open();
                if (mCamera != null) {
                    ...
                    if (!mInitialized) {
                        mInitialized = true;
                        mConfigManager.initFromCameraParameters(mCamera, width, height);
                    }
    ...
    public void flashLight(boolean b) {
        ...
        parameters.setFlashMode(b ? Camera.Parameters.FLASH_MODE_TORCH :
